...
const init = async () => {
    ...
    const getCache = await (async () => {
        ...
        const listenNotifications = async () => {
            ...
            console.log({path: fs.readFileSync('../../ca-certificate.crt').toString()})
            ...
            const subscriber = env.app.env === 'development' ? createSubscriber({ connectionString }) : createSubscriber({ connectionString, ssl: {  ca: fs.readFileSync('../../ca-certificate.crt').toString(),
